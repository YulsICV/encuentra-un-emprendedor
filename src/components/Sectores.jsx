  ...
  return (
    <section className="sectores">
      <div className="section-header">
        ...
        <a className="ver-todos">Ver todos →</a>
      </div>
      ...
      {activo && (
        <p className="sector-seleccionado">
          Mostrando emprendedores de:{' '}
          <strong>{SECTORES.find(s => s.id === activo)?.nombre}</strong>
        </p>
      )}
    </section>
  )
